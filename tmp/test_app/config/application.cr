...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Test App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= xmk_Rnxb6OnY3Iozg1rgt6_KBeCd4kA1pMT9Vl1Zj8c
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("test_app.log", "w"))
  #
  #
end
